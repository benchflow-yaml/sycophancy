#!/usr/bin/env python3
# BenchFlow Interface for Sycophancy Eval
# This file is a template for integrating Sycophancy Eval with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading Sycophancy Eval benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "agent",
            "github": "https://github.com/anthropics/evals/tree/main/evals/elsuite/sycophancy",
            "paper": "",
            "website": ""
        }
